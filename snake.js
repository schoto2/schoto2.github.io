...
// This function will let the snake know if the player passes the edge of the canvas or touch the snake it will cause it to end the game lines 35- 54
	collisionSnake() {
		let head = this.getHead();
 ...
 //This will make the snake change different colors when the body lenght increases
  show() {
